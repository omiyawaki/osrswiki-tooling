...
SOURCE_DIR = '/Users/miyawaki/Develop/osrswiki/cache/binary-assets/map-images/output'
SOURCE_IMAGES = [f'img-{i}.png' for i in range(4)]
TEMP_OUTPUT_DIR = os.path.join(PROJECT_ROOT, 'tools', 'map_tiles_temp')
ASSETS_DIR = '/Users/miyawaki/Develop/osrswiki/cache/binary-assets/mbtiles'
