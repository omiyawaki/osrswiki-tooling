...
echo "   ./scripts/ios/automate-app-testing.sh quick-map # Test with XCTest (recommended)"
echo "   ./scripts/ios/automate-app-testing.sh unit-tests # Run unit tests only"
echo ""
